...
coco_class_id = 3
complexity_threshold = 0.5  # 进行 hard_example 采样时图像复杂度的阈值
normal_example_possibility = 0.5
frame_path = "/home/junjie/1_dataset/BDD100K/images/val"
gt_path = "/home/junjie/1_dataset/BDD100K/labels_coco/bdd100k_det_labels.txt"
retrain_interval = 1000000  # 指的是重训练间隔的帧数
...
if __name__ == '__main__':
    ...
    small_all_ap = []
    results_ap = []
    for frame_id in tqdm(range(1, len(frames_list)+1)):  # len(frames_list)+1
            ...
            if hard_example_flag:
                ...
                for result in results:
                    ...
                    for box in boxes:
                        ...
                        slot_xywh.append({"bbox": [x1, y1, w1, h1], "category_id": yolo_class_id})
                if slot_xywh:
    ...
    if get_large_model_result:
        ...
        write_multi_list_to_txt([list(gt_data.keys()), small_f1_score, all_time, gpu_utilize], ["id", "small", "time", "gpu"])
