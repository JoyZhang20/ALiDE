...
class Coco2014Cfg(CocoCfg):
    variant: str = '2014'
    splits: Dict[str, dict] = field(default_factory=lambda: dict(
        train=dict(ann_filename='annotations/instances_train2014.json', img_dir='images/train2014', has_labels=True),
        val=dict(ann_filename='annotations/instances_val2014.json', img_dir='images/val2014', has_labels=True),
